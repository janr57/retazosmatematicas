...
k) Las componentes covariantes del gradiente a partir del apartado anterior y comprobación de que coinciden con el apartado \emph{g)}.\\
...
Mostramos el cambio de base, según la figura \ref{fig:R2-oblic_u1u2}, y su expresión
matricial
\[
  \begin{cases}
    \begin{array}{l}
...
El campo escalar en función del sistema oblicuo, según el apartado anterior es
\[
  \phi(x^1,x^2)
  = 2x^1 + \left(x^2\right)^2\sin\alpha\cos\alpha + 2x^2\cos\alpha + x^1x^2\sin\alpha
\]

La derivada covariante del campo escalar $\phi$ es
\[
  \partial_i\phi = \dfrac{\partial\phi}{\partial x^i}
\]
...
\begin{align*}
  ...
  &=
    ...
    = x^1\sin\alpha + 2x^2 \sin\alpha\cos\alpha + 2\cos\alpha
\end{align*}
que coincide con el apartado \emph{g)}.
