...
para nuestro sistema oblicuo concreto. Por último, realiza el cálculo particularizando para el vector $\vvv{v} = (x,y) = (3,2)$, en los casos en los que sea pertinente.\\
...
Cuando se aplica al vector $\vvv{v}$
\begin{align*}
  |\vvv{\nabla}\phi|^2
  &=
    \left(x^1\right)^2
...
\[
  ...
  \begin{cases}
    \begin{array}{l}
      ...
      \text{Sistema oblicuo \qty{60}{\degree} con } $\vvv{v} = (3,2)$ \text{ : }
      25
    \end{array}
  \end{cases}
\]
