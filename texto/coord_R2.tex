...
%f) Halla las componentes contravariantes del gradiente.\\
%
...
%\end{align*}
%
%Ahora necesitamos los valores de $x^1$ y $x^2$ para el punto $P(3,2)$
%\[
%  \begin{pmatrix}
%    x^1\\
%    x^2
...
%
%\noindent
%e) Componentes contravariantes del gradiente.
%
...
%    g^{11} \nabla\phi_1 + g^{12}\nabla\phi_2\\
%  &=
%    \dfrac{4}{3} (x^2\,\sin\alpha + 2)
%    - \dfrac{2}{3}\,(x^1\sin\alpha + x^2\sin(2\alpha) + 2\cos\alpha)\\
%  &=
%    x^2 \left(%
%    \dfrac{4}{3}\dfrac{\sqrt{3}}{2} - \dfrac{2}{3}\dfrac{\sqrt{3}}{2}
%    \right)
%    + \dfrac{8}{3}
%    - x^1 \,\dfrac{2}{3} \dfrac{\sqrt{3}}{2}
%    - 2\cdot\dfrac{2}{3}\cdot\dfrac{1}{2}\\
%  &=
%    x^2 \dfrac{\sqrt{3}}{3} - x^1 \dfrac{\sqrt{3}}{3} + 2
%\end{align*}
%
%\begin{align*}
%  \nabla\phi^2
...
%    g^{21} \nabla\phi_1 + g^{22}\nabla\phi_2\\
%  &=
%    - \dfrac{2}{3} (x^2\,\sin\alpha + 2)
%    + \dfrac{4}{3} (x^1\sin\alpha + x^2\sin(2\alpha) + 2\cos\alpha)\\
%  &=
%    x^2\left(%
%    -\dfrac{2}{3} \dfrac{\sqrt{3}}{2}+\dfrac{4}{3}\dfrac{\sqrt{3}}{2}
%    \right)
%    - \dfrac{4}{3}
%    + x^1 \,\dfrac{4}{3}\dfrac{\sqrt{3}}{2}
%    + 2\cdot \dfrac{4}{3}\, \dfrac{1}{2}\\
%  &=
%    x^2\, \dfrac{\sqrt{3}}{3}
...
%\end{align*}
%
%En nuestro particular sistema oblicuo
%\begin{align*}
%  \nabla\phi^1
%  &=
%    x^2\,\dfrac{\sqrt{3}}{3} - x^1\,\dfrac{\sqrt{3}}{3} + 2
...
%    - \left(%
%    3 - \dfrac{2\sqrt{3}}{3}
%    \right) \dfrac{\sqrt{3}}{3}
%    + 2 \\
%  &=
%    \dfrac{4}{3} - \sqrt{3} + \dfrac{2}{3} + 2
%    = 2 - \sqrt{3}
%\end{align*}
%\begin{align*}
%  \nabla\phi^2
%  &=
%    x^2\, \dfrac{\sqrt{3}}{3} + x^1\, \dfrac{2\sqrt{3}}{3} + \dfrac{4}{3}
%    = \dfrac{4\sqrt{3}}{3} \dfrac{\sqrt{3}}{3}
%    + \left(3 - \dfrac{2\sqrt{3}}{3}\right) \dfrac{2\sqrt{3}}{3}
%    + \dfrac{4}{3}\\
%  &=
%    \dfrac{4}{3} + 2\sqrt{3} - \dfrac{4}{3} + \dfrac{4}{3}
%    = \dfrac{4}{3} + 2\sqrt{3}
%\end{align*}
%\[
%  \begin{cases}
...
\qty{60}{\degree} entre sí, donde el eje de abcisas de ambos sistemas coinciden.\\
Calcula lo que se pide, primero en general, y después para nuestro sistema oblicuo
concreto, y para el vector vector $\vvv{v} = (x,y) = (3,2)$, en los casos en los que sea
pertinente.\\
a) El gradiente en cartesianas ortogonales y su módulo.\\
...
\[
  ...
  \begin{cases}
    ...
    \end{array}
  \end{cases}\\[4ex]
  \text{Para \qty{60}{\degree} y vector } \vvv{v} = (3,2)&
  \begin{cases}
    \begin{array}{l}
      \uvec{\i} = \uvec{\i}\\
...
En nuestro sistema oblicuo $\alpha=\qty{60}{\degree}$, tenemos
\[
  \begin{array}{ll}
...
En nuestro sistema oblicuo, con $\alpha = \qty{60}{\degree}$
\[
  \text{Tensor métrico y su inverso }
  \begin{cases}
    \begin{array}{l}
      \mmm{g}_{ij}
      = \begin{pmatrix}
...
\begin{align*}
  ...
  &=
    ...
    \,\left(x^1\sin\alpha + x^2\sin(2\alpha) + 2\cos\alpha\right)\\
  &=
    x^2\left(%
    \dfrac{1}{\sin\alpha}
    - \dfrac{\cos\alpha}{\sin^2\alpha} \cdot 2\sin\alpha\cos\alpha
    \right)
    - x^1\,\dfrac{\sin\alpha\cos\alpha}{\sin^2\alpha}
    + \dfrac{2}{\sin^2\alpha} - \dfrac{2\cos^2\alpha}{\sin^2\alpha}\\
  &=
    x^2\, \dfrac{1-2\cos^2\alpha}{\sin\alpha}
    - x^1\,\cot\alpha
    + 2 \left(\dfrac{1-2\cos^2\alpha}{\sin^2\alpha}\right)
\end{align*}
}
