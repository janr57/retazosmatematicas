...
\subsection{Espacio tangente y espacio dual}
...
\subsection{Base contravariante}
...
\subsection{Producto escalar de los vectores de las dos bases}
...
\[
  \phi(x,y) = xy+2x
\]
También consideramos un sistema de coordenadas cartesianas oblicuas, cuyos ejes forman
\qty{60}{\degree} entre sí, donde el eje de abcisas de ambos sistemas coinciden.\\
Calcula lo que se pide, primero en general, y después para nuestro sistema oblicuo
concreto y en el punto $P(3,2)$, en los casos en los que sea pertinente.\\
a) Calcula el gradiente en cartesianas ortogonales y su módulo.\\
b) Calcula la matriz de cambio de base $\mmm{M}$ y su inversa.\\
c) Halla la base covariante en función de la base ortogonal.\\
d) Obtén la métrica en coordenadas oblicuas y su inversa.\\
e) Calcula las componentes covariantes del gradiente.\\
%d) Halla las componentes covariantes del gradiente en función de las $x$ e $y$.
%e) Halla las componentes contravariantes del gradiente en función de las $x$ e $y$.\\

%%e) Calcula las componentes contravariantes del gradiente en función de las $x^i$ del
%%sistema oblicuo.\\
%g) Halla las componentes covariantes del gradiente.\\
%h) Calcula el módulo del gradiente en coordenadas oblicuas.\\

%c) Halla el campo en coordenadas oblicuas que forman un ángulo de \qty{60}{\degree}

%entre sus ejes.\\
%b) Calcula el gradiente en cartesianas ortogonales.\\
%c) Calcula el gradiente y su módulo en el punto $P=(2,1)$.\\
%d) Calcula el gradiente en coordenadas cartesianas oblicuas.\\
%e) Su valor y módulo en oblicuas, en el punto $P$.\\

\noindent
\textbf{Solución}

\noindent
a) Gradiente en cartesianas ortogonales y su módulo.
...
Gradiente y módulo en el punto $x=3$ e $y=2$
\begin{align*}
  &\vvv{\nabla}\phi(3,2)
    = (y+2)\,\uvec{\i} + x\,\uvec{\j}
    = (2+2)\,\uvec{\i} + 3\,\uvec{\j}
...
\noindent
c) Transformación de la base ortogonal a la covariante del sistema oblicuo.
...
En nuestro sistema oblicuo, los vectores de la base covariante son
\[
  \begin{cases}
    \begin{array}{l}
      \xhat{e}_1 = \uvec{\i}\\
...
\noindent
e) Componentes covariantes del gradiente.

Primero necesitamos obtener las coordenadas ortogonales a partir de las contravariantes,
utilizando la matriz de cambio de base
\[
  \begin{pmatrix}
    x\\
    y
...
\begin{align*}
  ...
  &=
    x^2\sin\alpha\cos\alpha + 2\cos\alpha + x^1\sin\alpha + x^2\cos\alpha\sin\alpha\\
  &=
    x^1\sin\alpha + x^2 \sin(2\alpha) + 2\cos\alpha
\end{align*}

En nuestro sistema oblicuo
\begin{align*}
  \nabla\phi_1
  &=
    x^2\sin\pi/3 + 2
...
\[
  \begin{cases}
    \begin{array}{l}
      ...
      = x^2\sin\pi/3\\
      \nabla\phi_2
      = x^1\sin\pi/3 + x^2\sin(2\pi/3) + 2\cos\pi/3
    \end{array}
  \end{cases}
\]

%\noindent
%e) Componentes covariantes del gradiente en función de $x$ e $y$.
%
%
%
%\noindent
%e) Componentes contravariantes del gradiente en función de $x$ e $y$.
%
%Realizamos la transformación inversa del apartado anterior, utilizando la matriz de
%cambio de base inversa $\mmm{M}^{-1}$
%\begin{align*}
%  \begin{pmatrix}
%    \uvec{\i} & \uvec{\j}
%  \end{pmatrix}
...
%\end{align*}
%
%Los vectores de  base ortogonal en función de los de la oblicua quedan
%\begin{align*}
%  \uvec{\i}
%  &=
%    \xhat{e}_1\\
...
%\end{align*}
%
%Sustituimos en la fórmula del  gradiente en coordenadas ortogonales del apartado \emph{a)}
%\begin{align*}
%  \vvv{\nabla}\phi
%  &=
%    (y+2)\,\uvec{\i} + x\,\uvec{\j}
%    = (y+2)\,\xhat{e}_1 + x(-\cot\alpha\,\xhat{e}_1 + \csc\alpha\,\xhat{e}_2)\\
%  &=
%    (-x\cot\alpha+y+2)\,\xhat{e}_1 + x\csc\alpha\,\xhat{e}_2
%\end{align*}
%
%Como $\vvv{\nabla}\phi = \nabla\phi^i\xhat{e}_i$, comparando términos resulta
%\begin{align*}
%  \nabla\phi^1
%  &=
%    -x\cot\alpha + y + 2\\
...
%\end{align*}
%
%Calculamos estas componentes para el sistema oblicuo del ejercicio, sustituyendo $x=3$,
%$y=2$ y $\alpha=\pi/3$ en la expresión anterior
%\begin{align*}
%  \nabla\phi^1
%  &=
%    -x\cot\alpha + y + 2
...
%\noindent
%e) Componentes contravariantes del gradiente en función de las componentes
%contravariantes $x^i$ del sistema oblicuo.
%
%Obtenemos el  valor de las $x$ e $y$ del sistema ortogonal en función de las componentes
%contravariantes $x^i$, utilizando la matriz de cambio de base
%\begin{align*}
%  \begin{pmatrix}
%    x\\
%    y
...
%\end{align*}
%
%Ahora sustituimos en las componentes contravariantes en función de las $x$ e $y$ del
%apartado anterior
%\begin{align*}
%  \nabla\phi^1
%  &=
%    -x\cot\alpha + y + 2
%    = -(x^1+x^2\cos\alpha)\cot\alpha
%    = -x^1\,\dfrac{\cos^2\alpha}{\sin\alpha}\\
%  \nabla\phi^2
%  &=
%    x\csc\alpha
%    = (x^1+x^2\cos\alpha) \csc\alpha
%    = x^1\csc\alpha + x^2\cot\alpha
%\end{align*}
%
%El gradiente en coordenadas oblicuas es
%\[
%  \vvv{\nabla}\phi
%  = -x^1\,\dfrac{\cos^2\alpha}{\sin\alpha}\,\xhat{e}_1
%  + (x^1\csc\alpha + x^2\cot\alpha) \xhat{e}_2
%\]
%
%Ahora calculamos las componentes $x^i$ en función de nuestro sistema oblicuo y de las
%componentes ortogonales $P(3,2)$
%\begin{align*}
%  \begin{pmatrix}
%    x^1\\
%    x^2
...
%\end{align*}
%Sustituimos en las componentes contravariantes
%\begin{align*}
%  \nabla\phi^1
%  &=
%    -x^1\,\dfrac{\cos^2\pi/3}{\sin\pi/3}
%    =-\left(3-\dfrac{2\sqrt{3}}{3}\right)\,\dfrac{1/4}{\sqrt{3}/2}
%    = \left(\dfrac{2\sqrt{3}}{3} - 3\right) \dfrac{1}{2\sqrt{3}}\\
%  &=
%    \left(\dfrac{2\sqrt{3}}{3} - 3\right) \dfrac{\sqrt{3}}{6}
%    = \dfrac{1}{3} - \dfrac{\sqrt{3}}{2}
%\end{align*}
%\begin{align*}
%  \nabla\phi^2
%  &=
%    x^1\csc\alpha + x^2 \cot\alpha
%    = \left(3-\dfrac{2\sqrt{3}}{3}\right)\,\csc\alpha + \dfrac{4\sqrt{3}}{3} \cot\alpha\\
%  &=
%    \left(3-\dfrac{2\sqrt{3}}{3}\right)\,\dfrac{2\sqrt{3}}{3}
%    + \dfrac{4\sqrt{3}}{3} \dfrac{\sqrt{3}}{3}
%    = 2\sqrt{3} - \cancelout{\dfrac{4}{3}} + \cancelout{\dfrac{4}{3}}
%    = 2\sqrt{3}
%\end{align*}
%
%
...
%  &=
%    g_{11}\nabla\phi^1 + g_{12}\nabla\phi^2
%    = \nabla\phi^1 + \nabla\phi^2 \cos\alpha\\
%  &=
%    -x^1\,\dfrac{\cos^2\alpha}{\sin\alpha} + (x^1\csc\alpha + x^2\cot\alpha) \cos\alpha
%    = -x^1\,\dfrac{\cos^2\alpha}{\sin\alpha}
%    + x^1\,\cot\alpha + x^2\,\dfrac{\cos^2\alpha}{\sin\alpha}\\
%  &=  x^1\,\dfrac{\cos\alpha-\cos^2\alpha}{\sin\alpha}
%    + x^2\,\dfrac{\cos^2\alpha}{\sin\alpha}
%\end{align*}
%
%
%\noindent
%h) Módulo del gradiente en coordenadas oblicuas.\\
...
%    \right)
%    = x^1\left(%
%    -\cot^2\alpha\csc\alpha + \cot^3\alpha
%    \right)
%\end{align*}
...
%\noindent
%a) El campo en coordenadas oblicuas
%\begin{align*}
%  \begin{pmatrix}
%    x\\
%    y
...
%  &=
%    \dfrac{1}{4}x^2y
%    = \dfrac{1}{4} \left(x^1 + \dfrac{\sqrt{3}}{2}x^2\right)^2 \dfrac{1}{2}x^2
%    = \dfrac{1}{8}\left[%
%    \left(x^1\right)^2 + \sqrt{3}x^1x^2 + \dfrac{3}{4}\left(x^2\right)^2
%    \right] x^2\\
%  &=
%    \dfrac{1}{8}\left[%
%    \left(x^1\right)^2 x^2
%    + \sqrt{3}x^1\left(x^2\right)^2
%    + \dfrac{3}{4}\left(x^2\right)^3
%    \right]
%\end{align*}
%
%\noindent
%b) El gradiente en cartesianas ortogonales.
%\[
%  \vvv{\nabla}\phi
%    = \dfrac{\partial\phi}{\partial x}\,\uvec{\i}
%    +\dfrac{\partial\phi}{\partial x}\,\uvec{\j}
%    = \dfrac{1}{4}\left(2xy\,\uvec{\i} + x^2\,\uvec{\j}\right)
%    = \dfrac{1}{2}xy\,\uvec{\i} + \dfrac{1}{4}x^2\,\uvec{\j}
%\]
%
%\noindent
%c) El gradiente y su módulo en coordenadas ortogonales, en $P=(2,1)$.
%\begin{align*}
%  &\vvv{\nabla}\phi(2,1)
%    = \dfrac{1}{2}\cdot 2\cdot 1\,\uvec{\i} + \dfrac{1}{4}\cdot 2^2\,\uvec{\j}
%    = \uvec{\i} + \uvec{\j}\\
%  &|\vvv{\nabla}\phi(2,1)|
%    = \sqrt{1^2+1^2}
%    = \sqrt{2}
...
%
%\noindent
%d) El gradiente en las coordenadas oblicuas.
%
%Derivadas parciales (componentes covariantes)
%\begin{align*}
%  \nabla\phi_1
%  &=
%    \dfrac{\partial\phi}{\partial x^1}
%    = \dfrac{1}{8}\left[%
%    2x^1x^2 + \sqrt{3}\left(x^2\right)^2
%    \right]\\
%  \nabla\phi_2
%  &=
%    \dfrac{\partial\phi}{\partial x^2}
%    = \dfrac{1}{8}\left[%
%    \left(x^1\right)^2 + 2\sqrt{3}x^1x^2+\dfrac{9}{4}\left(x^2\right)^2
%    \right]
%\end{align*}
%
%Para subir índices y obtener los componentes contravariantes, necesitamos la inversa
%de la métrica
%{\small
%\[
%  \mmm{g}^{ij}
...
%  &=
%    g^{11} \nabla\phi_ 1 + g^{12} \nabla\phi_2
%    = \dfrac{1}{\sin^2(\pi/6)} \left(\nabla\phi_1 - \cos(\pi/6) \nabla\phi_2\right)\\
%  &=
%    \dfrac{4}{8}
%    \left[%
%    2x^1x^2 + \sqrt{3}\left(x^2\right)^2
%    \right]
%    -\dfrac{2\sqrt{3}}{8}\left[%
%    \left(x^1\right)^2
%    + 2\sqrt{3}x^1x^2
%    + \dfrac{9}{4}\left(x^2\right)^2
%    \right]\\
%  &=
%    x^1x^2
%    + \dfrac{\sqrt{3}}{2}\left(x^2\right)^2
%    - \dfrac{\sqrt{3}}{4}\left(x^1\right)^2
%    - \dfrac{3}{2}x^1x^2
%    + \dfrac{9}{16}\left(x^2\right)^2\\
%  &=
%    -\dfrac{\sqrt{3}}{4}\left(x^1\right)^2
%    -\dfrac{1}{2} x^1x^2
%    + \dfrac{8\sqrt{3}+9}{16}\left(x^2\right)^2
%\end{align*}
%\begin{align*}
%  \nabla\phi^2
%  &=
...
%    - \sqrt{3}x^1x^2
%    + \dfrac{9}{8}\left(x^2\right)^2\\
%  &=
%    -\dfrac{1}{2}\left(x^1\right)^2
%    -\dfrac{3\sqrt{3}}{2} x^1x^2
%    + \dfrac{2\sqrt{3}+9}{8}\left(x^2\right)^2
%\end{align*}
%{\footnotesize
%\[
%  \vvv{\nabla}\phi
...
%
%\noindent
%d) El gradiente y su módulo en coordenadas oblicuas, en el punto $P$.
%\begin{align*}
%  \begin{pmatrix}
%    x^1\\
%    x^2
...
%    \right]
%    = \dfrac{1}{8}\left[%
%    2 \left(2 - \sqrt{3}\right)(-2) + \sqrt{3}\cdot (-2)^2
%    \right]\\
%  &=
%    \dfrac{1}{8}\left[%
%    -8 - \cancelout{4\sqrt{3}} + \cancelout{4\sqrt{3}}
%    \right]
%    = -1
%\end{align*}
%\begin{align*}
...
%  &=
%    \dfrac{1}{8}\left[%
%    \left(2 - \sqrt{3}\right)^2 + 2\sqrt{3} \left(2 - \sqrt{3}\right) (-2)
%    + \dfrac{9}{4}\cdot (-2)^2
%    \right]\\
%  &=
%    \dfrac{1}{8}\left[%
%    4 - \cancelout{4\sqrt{3}} + 3 - 8\sqrt{3} + \cancelout{4\sqrt{3}} + 9
%    \right]
%    = 2 - \sqrt{3}
%\end{align*}
%\begin{align*}
...
%  &=
%    g^{11}\nabla\phi_1 + g^{12}\nabla\phi_2
%    = 4 (-1) - 2\sqrt{3} \left(2-\sqrt{3}\right)\\
%  &=
%    -4 - 4\sqrt{3} + 6
%    = 2 - 4\sqrt{3}
%\end{align*}
...
%  &=
%    g^{21}\nabla\phi_1 + g^{22}\nabla\phi_2
%    = -2\sqrt{3}\cdot (-1) + 4 \left(2-\sqrt{3}\right)\\
%  &=
%    2\sqrt{3} + 8 - 4\sqrt{3}
%    = 8 - 2\sqrt{3}
%\end{align*}
...
%\[
%  \vvv{\nabla}\phi
%  = \left(2-4\sqrt{3}\right)\xhat{e}_1 + \left(8-2\sqrt{3}\right)\,\xhat{e}_2
%\]
%\begin{align*}
%  |\vvv{\nabla}\phi|
%  &=
%    \sqrt{\left(2-4\sqrt{3}\right)^2 + \left(8-2\sqrt{3}\right)^2}\\
%  &=
%    \sqrt{4 - 16\sqrt{3} + 48 + 64 - 32\sqrt{3} + 12}
%    = \sqrt{128 - 16\sqrt{3}}
%\end{align*}
...
%  \end{pmatrix}
%  \,\begin{pmatrix}
%    1 & -\dfrac{\sqrt{3}}{3}\\[1.2ex]
%    0 & \phantom{-}2
%  \end{pmatrix}
%    = \begin{pmatrix}
%      \xhat{e}_1 & -\dfrac{\sqrt{3}}{3}\,\xhat{e}_1 + 2\,\xhat{e}_2
%    \end{pmatrix}
%\end{align*}
%\begin{align*}
%  \uvec{\i} &= \xhat{e}_1\\
%  \uvec{\j} &= -\dfrac{\sqrt{3}}{3}\,\xhat{e}_1 + 2\,\xhat{e}_2
%\end{align*}
%\begin{align*}
%  \phi
%  &=
%    \dfrac{1}{2} xy\,\uvec{\i} + \dfrac{1}{4}x^2\,\uvec{\j}
%    = \dfrac{1}{2} xy\,\xhat{e}_1
%    + \dfrac{1}{4}x^2 \left(-\dfrac{\sqrt{3}}{3}\,\xhat{e}_1+2\,\xhat{e}_2\right)\\
%  &=
%    \left(\dfrac{1}{2} xy - \dfrac{\sqrt{3}}{12}x^2\right) \xhat{e}_1
%    + \dfrac{1}{2}x^2\,\xhat{e}_2
%    = \nabla\phi^1\,\xhat{e}_1 + \nabla\phi^2\,\xhat{e}_2
%\end{align*}
%\begin{align*}
%  \nabla\phi^1 &= \dfrac{1}{2} xy - \dfrac{\sqrt{3}}{12}x^2\\
%  \nabla\phi^2 &= \dfrac{1}{2}x^2
%\end{align*}
