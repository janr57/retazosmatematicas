...
suceso, realizadas por ambos observadores $(x,t)$ y $(x',t')$. La posición la representaremos en el eje de abcisas y el tiempo en ordenadas, como se hace en relatividad
especial y general.
...
Puede registrar las posiciones y tiempos del segundo observador o de cualquier otro
suceso.
Como la velocidad de $O'$ es constante, la gráfica del movimiento de $O'$ respecto de $O$
es una línea de pendiente constante. De la figura \ref{fig:R2-oblic_OO'_u}, vemos que
...
\[
  \cos(\pi/2 - \alpha) = \sin\alpha = \dfrac{|\xhat{e}_t|}{|\xtilde{e}_{t'}|};\hspace{0.5em}
  |\xtilde{e}_{t'}| = \dfrac{1}{\sin\alpha} = \csc\alpha
\]

\begin{subequations}
\begin{align}
  |\xtilde{e}_0| &= |\tilde{e}_{t'}| = \csc\alpha\\
...
\begin{figure}[ht]
  \begin{minipage}{0.45\linewidth}
    ...
    \caption{En rojo, los vectores de la base $B'$, donde $\xtilde{e}_{t'}$ se ve
      ...
      vectores unitario temporal y espacial de la base $B$. Las líneas horizontales son
      equitemporales. La que se muestra indica $t=t'=\qty{1}{\second}$.}
