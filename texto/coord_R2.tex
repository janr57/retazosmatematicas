...
\begin{equation}
  \vvv{v} = x_1\xhat{e}^1 + x_2\xhat{e}^2 = x_i \xhat{e}^i
\end{equation}
...
\begin{figure}[ht]
  \begin{minipage}{0.45\linewidth}  
    ...
    \begin{tikzpicture}[%
      ...
      \draw[covariante] (O) -- node[covtxt,pos=0.5, below] {$x_1\xhat{e}^1$} (COV1);
    ...
    \caption{Componentes covariantes $x_i$ en coordenadas oblicuas. El vector $\vvv{v}$
      se representa como $\vvv{v}=x_1\,\xhat{e}^1 + x_2\,\xhat{e}^2$. Las componentes
