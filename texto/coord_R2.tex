...
Un campo escalar está definido en $\symbb{R}^2$ por
$\phi(x,y) = \dfrac{1}{4}x^2y$.\\[1ex]
a) Calcula el gradiente en cartesianas ortogonales, su valor concreto en $(x,y)=(2,1)$
y su módulo.
b) Exprésalo en coordenadas cartesianas oblicuas que forman un ángulo de \qty{30}{\degree} entre sus ejes.\\
c) Calcula el gradiente en oblicuas.

\noindent
\textbf{Solución}

\noindent
a) Gradiente, su valor y cuadrado en $(2,1)$
\begin{align*}
  &\vvv{\nabla}\phi
    = \dfrac{\partial\phi}{\partial x}\,\uvec{\i}
...
\noindent
b) Campo en coordenadas oblicuas
\begin{align*}
  \begin{pmatrix}
    x\\
    y
