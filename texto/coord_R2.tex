...
Supongamos que tenemos un campo escalar $\phi$ definido en $\symbb{R^2}$ y expresado
en coordenadas oblicuas, según sus componentes contravariantes (utilizando la base covariante $\xhat{e}_1$ y $\xhat{e}_2$)
\begin{equation}
  \phi = \phi(x^1, x^2)
\end{equation}
Como sabemos, los vectores unitarios no cambian con la
