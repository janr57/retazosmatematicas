...
\item Base natural:
  ...
  contravariantes $x^i$ de los vectores. Ver figura \ref{fig:R2-oblic_contrav}.

  La base natural se utilizará más adelante para obtener la métrica de estos sistemas
  oblicuos.
\end{itemize}
\begin{figure}[ht]
  % Escala
