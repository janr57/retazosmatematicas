...
d) Halla las componentes contravariantes del gradiente en función de las $x$ e $y$ del
sistema ortogonal.\\
...
\noindent
c) Matriz de cambio de base y su inversa.

El cambio de base es, según la figura \ref{fig:R2-coord_oblicuas_e1e2}
\begin{align*}
  \xhat{e}_1 &= \uvec{\i}\\
  \xhat{e}_2 &= \cos\alpha\,\uvec{\i} + \sin\alpha\,\uvec{\j}
\end{align*}
Lo anterior se representa matricialmente
\[
  \begin{pmatrix}
    \xhat{e}_1 & \xhat{e}_2
  \end{pmatrix}
  ...
  \end{pmatrix}
\]
De aquí, que la matriz de cambio de base sea
\[
  \mmm{M}
  =\begin{pmatrix}
    1 & \cos\alpha\\
...
\noindent
c) Base covariante en función de la base ortogonal.
...
\begin{align*}
  ...
  &=
    ...
    \end{pmatrix}
    = \begin{pmatrix}
      \uvec{\i} & \cos\alpha\,\uvec{\i}+\sin\alpha\,\uvec{\j}
    \end{pmatrix}
\end{align*}
Los vectores de la base covariante son
\begin{align*}
  &\xhat{e}_1 = \uvec{\i}\\
  &\xhat{e}_2 = \cos\alpha\,\uvec{\i} + \sin\alpha\,\uvec{\j}
\end{align*}
...
\noindent
d) Componentes contravariantes del gradiente en función de las coordenadas $x$ e $y$ del
sistema ortogonal.

Sustituimos la base  por la covariante del sistema
oblicuo , utilizando la matriz inversa de cambio de
base
Expresamos los vectores de la base $B=\set{\uvec{\i},\,\uvec{\j}}$ en función de los
covariantes de la base oblicua $B'=\set{\xhat{e}_1, \xhat{e}_2}$
\begin{align*}
  \begin{pmatrix}
    \uvec{\i} & \uvec{\j}
  \end{pmatrix}
...
Los sustituimos en el gradiente en cartesianas ortogonales del primer apartado
\begin{align*}
  \vvv{\nabla}\phi
  &=
    (y+2)\,\uvec{\i} + x\,\uvec{\j}
...
Calculamos estas componentes para el sistema oblicuo del ejercicio,
sustituimos $x=3$, $y=2$ y $\alpha=\pi/3$ en la expresión anterior
\begin{align*}
  \nabla\phi^1
  &=
    -3\cot\pi/3 + 2 + 2
...
\noindent
f) Métrica y su inversa. Aplícala al sistema oblicuo.

La métrica se calcula mediante el producto escalar de los vectores de la base
\begin{align*}
  \mmm{g}_{ij}
  &=
    \begin{pmatrix}
...
\begin{align*}
  ...
  &=
    ...
    = -x^1\,\dfrac{\cos^2\alpha}{\sin\alpha}
    + (x^1\csc\alpha + x^2\cot\alpha) \cos\alpha
\end{align*}
