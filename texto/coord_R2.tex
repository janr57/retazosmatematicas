...
Nótese que el versor $\xhat{e}_1=\uvec{\i}$ debido a que representamos el
eje $x$ en coordenadas rectangulares coincidiendo con $\hat{x}^1$ en coordenadas
oblícuas. Ver figura \ref{fig:R2-coord_oblicuas_e1e2}.
\begin{figure}[ht]
  \centering
  % Escala
  \def\scl{1.00}
...
representado desde el principio con el acento circunflejo
\begin{align}
  \|\xhat{e}_1\|
  &=
    \|\uvec{\i}|| = 1\\
...
De aquí deducimos la matriz de transformación de la base rectangular a la oblícua y su
inversa
\begin{subequations}
\begin{align}
  \begin{pmatrix}
...
Por tanto, las matrices de transformación de bases de rectangulares a oblícuas y su
inversa son
\begin{align}
  \mmm{M}
  &=
