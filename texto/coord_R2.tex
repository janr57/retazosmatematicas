...
Aplica los resultados anteriores al punto $P(3,2)$.\\
b) Calcula la matriz de cambio de base $\mmm{M}$ y su inversa.
Aplicar al sistema oblicuo con $\alpha=\qty{60}{\degree}.$\\
c) Halla la base covariante en función de la base ortogonal. Y aplícala al sistema
oblicuo.\\
d) Obtén la métrica y su inversa. Aplícala al sistema oblicuo.\\
...
\noindent
c) Matriz de cambio de base y su inversa. Aplicar al sistema oblicuo con
\qty{60}{\degree}.
...
\noindent
d) Métrica y su inversa. Aplícala al sistema oblicuo.
