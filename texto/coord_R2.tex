...
\item Ejes y su notación:
  ...
  horario un ángulo $\beta = \qty{90}-\alpha$.
  ...
  \end{itemize}
\item Base natural:
  La base más utilizada en el sistema oblicuo es la base covariante, formada por vectores
  ...
  vectores unitarios, aunque esto no es cierto en general.

  Muy importante: estos vectores covariantes se utilizan para medir las componentes
  contravariantes de los vectores. Así, las componentes contravariantes medidas por
  estos vectores se representan mediante $x^1$ y $x^2$. Ver figura
...
La base natural $B'$ en el sistema oblicuo está formada por los dos vectores covariantes
(nótese el subíndice en los vectores)
