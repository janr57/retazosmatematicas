...
a) Calcula el cuadrado del vector $\vvv{v}$.\\
b) Calcula sus componentes contravariantes en un sistema de coordenadas oblicuas de \qty{60}{\degree}, mediante una transformación de componentes.\\
c) Calcula estas componentes mediante transformación de los vectores de la base $B$.\\
d) Obtén el tensor métrico en el sistema oblicuo.\\
e) Halla las componentes covariantes del vector.\\
f) Halla el cuadrado del módulo del vector en el sistema oblicuo.\\
...
\[
|\vvv{v}|^2
= \left(2\,\uvec{\i}+\sqrt{3}\,\uvec{\j}\right)
\cdot
\left(2\,\uvec{\i}+\sqrt{3}\,\uvec{\j}\right)
...
\noindent
b) La matriz de cambio de base $\mmm{M}$ es \ref{eq:R2-oblic_M}. Para calcular las
componentes en la nueva base, tenemos que utilizar la matriz inversa $\mmm{M}^{-1}$,
\ref{eq:R2-oblic_Minv}
\[
  [x]_{B'} = \mmm{M}^{-1} [x]_{B}
\]
\[
...
\noindent
c) Necesitamos obtener los vectores de la base antigua $B=\set{\uvec{\i},\uvec{\j}}$ en
...
\noindent
d) Para calcular el tensor métrico y su inversa, tenemos que calcular el módulo de los
vectores de la base $B'=(\vvv{e}_1, \vvv{e}_2)$
\begin{align*}
  \begin{pmatrix}
    \vvv{e}_1 & \vvv{e}_2
  \end{pmatrix}
...
Los vectores de la base natural
\begin{align*}
  \vvv{e}_1
  &=
    \uvec{\i}\\
...
Son vectores unitarios $\vvv{e}_1 = \xhat{e}_1$ y $\vvv{e}_2 = \xhat{e}_2$
\begin{align*}
  |\vvv{e}_1|^2
  &=
    \uvec{\i}\cdot\uvec{\i}
