...
No lo hemos hecho en el sistema cartesiano rectangular porque ambas componentes son
idénticas, pero aquí sí hay diferencia.
...
segmento orientado. Esta es la forma natural con la que sumamos vectores mediante la
regla del paralelogramo, ver figura \ref{fig:R2-oblic_contrav}.
\begin{figure}[ht]
  % Escala
  \def\scl{1.00}
  % 
...
multiplicadas por sus respectivos vectores unidad, nos da el desplazamiento que nos
señala el vector. Visto de otra manera, cada componente contravariante $A^i$,
proporcionan información acerca del espacio recorrido en cada eje.
...
\begin{figure}[ht]
  \begin{minipage}{0.45\linewidth}
    ...
    \begin{tikzpicture}[%
      ...
      \end{scope}
    \end{tikzpicture}
    \caption{La componente covariante $A_1$ del vector en coordenadas oblícuas .}
