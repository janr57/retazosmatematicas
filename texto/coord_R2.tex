...
El principio de relatividad de Galileo se puede interpretar utilizando un sistema de
coordenadas oblicuo, un tanto especial. Aquí presentamos una versión bidimensional,
$x$ y $t$.

Supongamos un observador inercial $O$ que supondremos en reposo.
