...
b) Aplica los resultados anteriores al punto $P(2,1)$.\\
c) Calcula la matriz de cambio de base $\mmm{M}$ y su inversa.\\
...
\noindent
b) Gradiente y cuadrado en el punto $x=2$ e $y=1$.
\begin{align*}
  &\vvv{\nabla}\phi
    = (y+2)\,\uvec{\i} + x\,\uvec{\j}
    = (1+2)\,\uvec{\i} + 2\,\uvec{\j}
