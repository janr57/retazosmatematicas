...
vectores de la base \eqref{eq:R2-oblic_base}, pero antes vamos a expresar estos vectores
en función de los $\uvec{\i}$ y $\uvec{\j}$ de las cartesianas rectangulares
\begin{align}
  \xhat{e}_1 &= \uvec{\i}\\
