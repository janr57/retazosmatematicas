...
\begin{align*}
  ...
  &=
    ...
    = (x^2\sin\alpha+2)\cdot\cos\alpha + (x^1 + x^2\cos\alpha)\cdot\sin\alpha\\
  &=
    x^1\sin\alpha + x^2 \,2\sin\alpha\cos\alpha + 2\cos\alpha
\end{align*}
...
\begin{align*}
  ...
  &=
    - \dfrac{2}{3} (x^2\,\sin\alpha + 2)
    + \dfrac{4}{3} (x^1\sin\alpha + x^2\,2\sin\alpha\cos\alpha + 2\cos\alpha)\\
  &=
    x^2\left(%
    -\dfrac{2}{3}\dfrac{\sqrt{3}}{2}+\dfrac{4}{3}\cdot 2\,\dfrac{\sqrt{3}}{2}\dfrac{1}{2}
    \right)
    - \dfrac{4}{3}
    + x^1 \,\dfrac{4}{3}\dfrac{\sqrt{3}}{2}
    + 2\cdot \dfrac{4}{3}\, \dfrac{1}{2}\\
