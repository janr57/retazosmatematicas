...
Escribe la matriz $\mmm{M}$ de cambio de base y su inversa $\mmm{M}^{-1}$.\\
c) Obtén el tensor métrico en el sistema oblícuo anterior.\\
d) Halla las componentes contravariantes del vector del apartado a).\\
e) ¿Cuáles son las componentes covariantes del vector?\\
