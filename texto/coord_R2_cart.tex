...
cuadrado, el primero, situado en el intervalo abierto $(x_0, x_0+h)$ del lado inferior,
y el segundo, en el mismo intervalo $(x_0, x_0+h)$ del lado superior.
De manera similar, representaremos los puntos $C$ y $D$, en puntos de los lados
izquierdo y derecho, respectivamente, situados en el intervalo vertical $(y_0, y_0+h)$.
...
vectorial $\vvv{F}$ es el campo de velocidades de un fluido imaginario,
$\vvv{F}(x,y) = \vvv{v}(x,y)$, que se mueve en un plano (con un valor de $z$
...
$A$ y $C$, y sale por $B$ y $D$ ---en caso de que no fuera así, aparecería
automáticamente un signo negativo en la parte correspondiente de las ecuaciones, por lo
que no nos preocuparemos de ello---.
...
\[
  \begin{cases}
    \begin{array}{lll}
      ...
      &\longrightarrow
      &F_y(x_0+a, y_0+b) h^2 - F_y(x_0+a, y_0+h)\,h^2\\[1ex]
      \text{\emph{Caudal} horizontal saliente }
      &\longrightarrow
      &F_x(x_d0+h, y_0+b) h^2 - F_x(x_0, y_0+b)\,h^2
    \end{array}
  \end{cases}
\]
