...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    \node[texovector, above right=-3pt and -4pt] at (FD) {$\vvv{F}_{d}$};
  ...
  \caption{En las figuras se representa un pequeño cuadrado de lado $h$ en el punto
    $P(x_0,y_0)$.
    A la izquierda se representa el flujo a través de las caras superior e inferior,
    representadas por las componentes verticales, en rojo, del valor del campo en cada
    punto arbitrario $A$ y $B$ de esas caras.
    A la derecha se representa el flujo a través de las caras izquierda y derecha,
    en los puntos $C$ y $D$, representado por las componentes horizontales, también en
    rojo.}
