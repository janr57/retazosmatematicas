...
%    % Proyección de elemento de área en los ejes
    ...
    % Vectores
    \path[save path=\vectorAinf] (Ainf) -- ++(\VAINFANG:\VAINFMOD);
    \path[save path=\vectorAsup] (Asup) -- ++(\VASUPANG:\VASUPMOD);
    \path[save path=\vectorBizdo] (Bizdo) -- ++(\VBIZDOANG:\VBIZDOMOD);
    \path[save path=\vectorBdcho] (Bdcho) -- ++(\VBDCHOANG:\VBDCHOMOD);
