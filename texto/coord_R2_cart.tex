...
Los vectores \emph{viven} en un espacio plano $V$\, llamado \emph{espacio tangente}.
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[%
    ...
    % 1. ESFERA
    \shade[ball color=black!20!white, opacity=0.9] (0,0) circle (1);
    \draw[gray!10] (0,0) circle (1);

    % 2. PLANO SUPERIOR
    \coordinate (P1) at (0,1,0); 
    \filldraw[blue!60!black, fill=blue!20, fill opacity=0.8] 
      ([shift={(-0.55, 0,  0.55)}]P1) -- 
      ([shift={( 0.55, 0,  0.55)}]P1) -- 
      ([shift={( 0.55, 0, -0.55)}]P1) -- 
      ([shift={(-0.55, 0, -0.55)}]P1) -- cycle;
      
    \fill[black] (P1) circle (0.5pt);
    \node[left] at (P1) {$P_1$};

    % 3. PLANO FRONTAL DERECHA
    \coordinate (P2) at (0.85, 0.3, 0.43); 

    % Vectores SIMÉTRICOS respecto a P2 para que quede centrado
    % Se usan desplazamientos opuestos: (a,b,c) y (-a,-b,-c)
    \filldraw[red!60!black, fill=red!20, fill opacity=0.8] 
      ([shift={(-0.25, -0.4,  0.5)}]P2) -- 
      ([shift={( 0.25, -0.4, -0.5)}]P2) -- 
      ([shift={( 0.25,  0.4, -0.5)}]P2) -- 
      ([shift={(-0.25,  0.4,  0.6)}]P2) -- cycle;

    \fill[black] (P2) circle (0.5pt);
    \node[below left=-1pt and -2pt] at (P2) {$P_2$};
