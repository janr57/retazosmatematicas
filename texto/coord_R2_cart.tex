...
Supongamos un campo vectorial $\vvv{F} = F_x\,\uvec{\i} + F_y\,\uvec{\j}$, que
podemos escribir también, de una manera más matemática como
\[
  \vvv{F} = M(x,y)\,\uvec{\i} + N(x,y)\,\uvec{\j}
\]
