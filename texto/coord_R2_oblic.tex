...
\item Ejes y su notación:
  ...
  \item Notación en álgebra lineal y física clásica:
    El eje horizontal se suele representar como $x$, $\tilde{x}$, $x'$ o $\mu$, y el
    inclinado como $y$, $\tilde{y}$, $y'$ o $\nu$.
  ...
  \item Notación en cálculo tensorial y geometría diferencial:
    Para los ejes, se usan preferentemente superíndices $x^1$ y $x^2$, o $x^\mu$ y $x^\nu$
