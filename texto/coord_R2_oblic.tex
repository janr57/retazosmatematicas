...
En física general se suelen utilizar bases formadas por vectores unitarios.
Para tener una base basta con que los vectores que la forman sean linealmente
independientes. Así, cualquier vector del espacio se podrá representar como una
...
\begin{equation}\label{eq:R2-oblic_base_natural}
  B' = \set{\vvv{e}_1, \vvv{e}_2}
\end{equation}
Esta base nos podrá servir para obtener la métrica de estos sistemas oblicuos que, a su
vez, nos permitirá relacionar las componentes covariantes y las contravariantes, entre
sí.

\subsection{Cálculo geométrico}
Hasta que no obtengamos la matriz de cambio de base, para obtener la base natural vamos
a recurrir a un procedimiento geométrico.
