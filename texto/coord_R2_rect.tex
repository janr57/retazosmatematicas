...
posición que representa a cada punto del espacio, expresado en función de las
componentes del sistema, en este caso las coordenadas $x$ e $y$, respecto de
cada una de ellas.
Véase la ecuación \eqref{eq:R2-r_rect} y la figura \ref{fig:R2-rect_ij},
...
Los vectores de la base natural son
Así, se obtiene
\begin{subequations}
