...
\begin{figure}[ht]
  ...
  \pgfmathsetmacro{\OPACIDADPLANO}{0.8}
  % Punto de vista
  \pgfmathsetmacro{\THETA}{56.0}
  \pgfmathsetmacro{\PHI}{40.0}
  % Punto P1 (Pa)
  \pgfmathsetmacro{\Patheta}{0}
  \pgfmathsetmacro{\Paphi}{0}
  % Punto P2 (Pb)
  \pgfmathsetmacro{\Pbtheta}{45}
  \pgfmathsetmacro{\Pbphi}{50}
  % Eje x
  \pgfmathsetmacro{\UX}{-sin(\PHI)}
  \pgfmathsetmacro{\VX}{-cos(\THETA) * cos(\PHI)}
  % Eje y
  \pgfmathsetmacro{\UY}{cos(\PHI)}
  \pgfmathsetmacro{\VY}{-cos(\THETA) * sin(\PHI)}
  % Eje z
  \pgfmathsetmacro{\UZ}{0}
  \pgfmathsetmacro{\VZ}{sin(\THETA)}
  % 
  \centering
  \begin{tikzpicture}[%
    scale=\scl,
    ...
    \coordinate (C) at (\Cu,\Cv);
    % Eje x
    %\path[save path=\ejex] (O) -- \proyPRect{1}{0}{0}{\THETA}{\PHI};
    % Eje y
    %\path[save path=\ejey] (O) -- \proyPRect{0}{1}{0}{\THETA}{\PHI};
    % Eje z
    %\path[save path=\ejez] (O) -- \proyPRect{0}{0}{1}{\THETA}{\PHI};
    % Punto P1
    \coordinate (P1) at (\proyPRect{0}{0}{1}{\THETA}{\PHI});
    %\coordinate (P1) at \proyPRect{0}{0}{1}{\THETA}{\PHI};
    % P2
    %\coordinate (P2) at (\Pbu, \Pbv);
    % -------------------------------------------------------------------------
    ...
    % Punto P1
    \coordinate (P1) at (\proyPRect{0}{0}{1}{\THETA}{\PHI});
    % \fill[punto] (P1) circle;
    %\fill[punto,red] \proyPRect{1}{0}{0}{\THETA}{\PHI} circle[] coordinate (P1);
    %\fill[punto,green] \proyPRect{0}{1}{0}{\THETA}{\PHI} circle[] coordinate (P2);
    %\fill[punto,blue] \proyPRect{0}{0}{1}{\THETA}{\PHI} circle[] coordinate (P1);
    %\coordinate (P1) at \proyPRect{0}{0}{1}{\THETA}{\PHI};

    \fill[white] (P1) circle[radius=0.25pt];
    % Punto P2
