...
\begin{luacode*}
  ...
  -- Datos de la vista
  observador = {thetaD = 60, phiD = 30}
  -- 3. Matriz de puntos (tabla de tablas)
  puntos = {
    { theta = 80, phi = 190, a = 1, b = 1, opacidad = 0.5, color = "black!20" },
    { theta = 0, phi = 0, a = 2, b = 2, opacidad = 0.5, color = "red" },
    { theta = 90, phi = 180, a = 3, b = 3, opacidad = 0.7, color = "blue" },
    { theta = 40, phi = 30, a = 4, b = 4, opacidad = 0.7, color = "blue" }
  }
\end{luacode*}

\proyEsferatxt{esfera}{observador}{puntos}
\proyEsfera{esfera}{observador}{puntos}
