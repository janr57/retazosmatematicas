...
%\section*{Puntos en una esfera}

\begin{luacode*}
  -- Datos de la esfera
  esf = {
    radio = 1.0, color = "gray!10", opacidad = 0.4,
    sombracolor = "black!20", sombraopacidad=0.9
  }
  -- Datos del observador
  obs = {thetaD = 60, phiD = 30}
  -- 3. Matriz de puntos (tabla de tablas)
  ptos = {
    {thetaD=80, phiD=190, a=1, b=1, opacidad=0.5, color="black"},
    {thetaD=0, phiD=0, a=2, b=2, opacidad=0.5, color="red"},
    {thetaD=90, phiD=180, a=3, b=3, opacidad=0.7, color="green"},
    {thetaD=40, phiD=30, a=4, b=4, opacidad=0.7, color="blue"}
  }

  -- Cálculo de las coordenadas del punto proyectadas en la pantalla
  for i, p in ipairs(ptos) do
     u, v = mEsfera.proyPuntoSph(esf.radio, p.thetaD, p.phiD, obs)
     p.u = u
     p.v = v
  end
\end{luacode*}
...
\DEBUGproyEsfera{esf}{obs}{ptos}
%\proyEsfera{esf}{obs}{ptos}

%\begin{tabular}{|c|c|c|c|}
%  \hline
%  radio & color & color sombra & opacidad sombra\\
%  \hline
%  1.0 & black!20 & red & 0.96\\
%  \hline
%\end{tabular}
...
%  % Punto P2 (Pb)
%  \pgfmathsetmacro{\Pbtheta}{45.0}
%  \pgfmathsetmacro{\Pbphi}{50.0}
%  % Eje x
...
%    line cap=round,
%    every node/.style={black,font=\scriptsize},
%    punto/.style={black, radius=0.5pt},
%    planoP1/.style={blue!60!black, fill=blue!20, opacity=\OPACIDADPLANO},
%    planoP2/.style={red!60!black, fill=red!20, opacity=\OPACIDADPLANO},
%    vector/.style={-{Latex[round,width=3pt,length=4pt]}},
%    ]
...
%    % P2
%    \coordinate (P2) at (\proyPSph{1}{50}{80}{\THETA}{\PHI});
%    % -------------------------------------------------------------------------
%    % DIBUJOS
%    % 1. ESFERA
