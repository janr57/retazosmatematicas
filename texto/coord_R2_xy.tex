...
-- 1. Datos y propiedades de la esfera:
  esf = {
    radio = 1.0, color = "gray!10", opac = 1, sombracolor = "black!20", sombraopac=0.9
  }
  ...
  puntosprop = {
    radiovis = "0.4pt", invis=true,
    radinvis = "0.3pt", colorvis="black", colorinvis="red", opacvis=1, opacinvis=0.5
  }
...
mEsfera.completaPlanos(obs, ptos, planos)
m.Esfera.completaVectores(obs, ptos, planos, vectores)
...
{\scriptsize
  \par
  \noindent\DEBUGEsf{esf}\par
  \noindent\DEBUGObs{obs}\par
  \noindent\DEBUGPuntos{ptos}\par
...
\begin{figure}[ht]
  ...
  \TIKZEsferaPlanos{1.9}{esf}{obs}{ptos}{planos}
\end{figure}
