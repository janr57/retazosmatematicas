...
Ese plano es el espacio tangente o espacio vectorial asociado al punto donde
\emph{viven} los vectores.
...
\begin{figure}[ht]
  ...
  \centering
    \cargaDatos{datoslua/esf_zppv_01.lua}
    \begin{tikzpicture}[scale=0.90,]
      \dibujaTikzEsfera[false]
      %\node at (-0.7,-1) {\footnotesize $P_1$};
      %\node at (-0.17,1.65) {\scriptsize $P_2$};
    \end{tikzpicture}
