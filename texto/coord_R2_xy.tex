...
-- 1. Datos y propiedades de la esfera:
  esf = {
    escala=1.0,radio=2.0,color="gray!10",opac=1,sombracolor="black!20",sombraopac=0.9
  }
  ...
  ptos = {
    {thetaD=90, phiD=186, a=0.4, b=0.4, opac=0.8, draw="black!80", fill="black!10"},
    {thetaD=0, phiD=0, a=1.0, b=1.0, opac=0.8, draw="blue!80!black", fill="blue!20"},
    {thetaD=90, phiD=170, a=3, b=3, opac=0.8, draw="green!80!black", fill="green!20"},
    {thetaD=120, phiD=50, a=0.9, b=0.9, opac=0.8, draw="red!80!black", fill="red!20"}
  }
...
vectores = {
  {puntoID=1, r=0.5, thetaD=45},
  {puntoID=1, r=0.4, thetaD=0},
  {puntoID=2, r=0.9, thetaD=90},
}
...
mEsfera.completaPuntos(unit, esf, obs, ptos)
mEsfera.completaPlanos(unit, esf, obs, ptos, planos)
mEsfera.completaVectores(unit, esf, obs, ptos, planos, vectores)
...
%  \TIKZEsferaPlanos{unit}{esf}{obs}{ptosprop}{ptos}{planos}
%\end{figure}
