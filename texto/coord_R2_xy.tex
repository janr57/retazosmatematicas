...
Pero, adelantaremos algo de información para captar su significado y entender por qué en
otros sistemas de coordenadas estos vectores son diferentes, al contrario de lo que
ocurre en este.
...
-- Datos de la esfera:
  ...
  ptos = {
    ...
    {thetaD=0, phiD=0, color="black", a=1.0, b=1.0, opac=0.8, draw="red!80!black", fill="red!20"},
    {thetaD=90, phiD=170, color="black", a=3, b=3, opac=0.8, draw="green!80!black", fill="green!20"},
    {thetaD=120, phiD=50, color="black", a=0.9, b=0.9, opac=0.8, draw="blue!80!black", fill="blue!20"}
  }
  
-- 4. Matriz de planos. Se crea la matriz de planos:
planos = {}
