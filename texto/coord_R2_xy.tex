...
\item Introducir algunas ideas de la geometría diferencial, tales como
  \emph{base natural}, \emph{métrica}, etc., que serán más importantes en otros
  sistemas de coordenadas.
\item Recordar la expresión del resultado de distintas operaciones del cálculo en
  este sistema.
\end{enumerate}
...
\begin{equation}\label{eq:R2-r_rect}
  ...
  = x\,\uvec{\i} + y\,\uvec{\j}
\end{equation}
En la figura \ref{fig:R2-rect_ij} lo representamos:
\begin{figure}[ht]
...
-- 1. Datos y propiedades de la esfera:
  ...
  ptpr = {
    invisib=true, rv=0.025, ri=0.015, colorv="black", colori="red", opacv=1.0, opaci=0.5
  }
