...
\begin{luacode*}
  ...
  ptos = {
    {thetaD=90, phiD=186, a=0.4, b=0.4, opacidad=0.5, color="black"},
    {thetaD=0, phiD=0, a=0.8, b=0.8, opacidad=0.5, color="red"},
    {thetaD=90, phiD=170, a=3, b=3, opacidad=0.7, color="green"},
    {thetaD=40, phiD=180, a=4, b=4, opacidad=0.7, color="blue"}
  }
  -- Planos
  planos = {}
 
  -- Añade r y u, v a la tabla ptos
