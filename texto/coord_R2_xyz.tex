...
\begin{luacode*}
  ...
  ptos = {
    {thetaD=90, phiD=186, a=0.5, b=0.5, opacidad=0.5, color="black"},
    {thetaD=0, phiD=0, a=0.5, b=0.5, opacidad=0.5, color="red"},
...
{\scriptsize
  \par
  \noindent\DEBUGEsfera{esf}\par
  \noindent\DEBUGObservador{obs}\par
