...
coordenadas, $r$ y $\theta$. La primera coordenada es la distancia entre el origen de
coordenadas y un punto del espacio, y la segunda es el ángulo que forma el eje de
abcisas con la línea que une el origen de coordenadas con el punto, ver figura
