...
{\small
  \begin{equation}\label{eq:R2-gradiente_escalar}
    \vvv{\nabla}\cdot f
    =
      \dfrac{\partial f}{\partial x}\,\uvec{\i}
      + \dfrac{\partial f}{\partial y}\,\uvec{\j}
...
\begin{enumerate}
\item Enfoque matricial.
  
  En este producto escalar se utiliza la métrica en polares
...
\item Enfoque basado en la variación de los vectores unitarios.
  ...
  $\vvv{A} = A_r\xhat{r}+A_\theta\xhat{\theta}$, no solo actúa sobre las componentes $A_r$ y
  $A_\theta$, sino también sobre los vectores unitarios $\xhat{r}$ y $\xhat{\theta}$,
  ...
  \begin{equation}
    ...
    = 0
  \end{equation}
\item Al desplazarnos infinitesimalmente en sentido antihorario, $\xhat{r}$ cambia
  según $\xhat{\theta}$, ver por ejemplo, ángulos $\pi/6$\,\unit{\radian} y
...
\item Al desplazarnos infinitesimalmente en sentido antihorario, $\xhat{\theta}$ cambia
  ...
  \end{equation}
  También necesitamos el operador nabla en polares, que podemos obtenerlo a partir del
  gradiente de un campo escalar en polares \eqref{eq:R2-gradiente_escalar}
  \begin{equation}
    \vvv{\nabla}
  ...
  Con todo lo anterior, pasamos a calcular la divergencia de un campo vectorial en
  polares
  {\scriptsize
  \begin{align*}
    \vvv{\nabla}\cdot\vvv{A}
    &=
      \left(%
      \xhat{r}\dfrac{\partial}{\partial r} + \xhat{\theta}\dfrac{\partial}{\partial\theta}
      \right)
      \cdot
    ...
    &=
      ...
      + \dfrac{\partial A_\theta}{\partial r}\xhat{\theta}
      + \cancelout{A_\theta\dfrac{\partial\xhat{\theta}}{\partial r}}
      \right)
      + \dfrac{1}{r}\xhat{\theta}\cdot
      \left(%
      \dfrac{\partial A_r}{\partial\theta}\xhat{r}
      + A_r\dfrac{\partial\xhat{r}}{\partial\theta}\xhat{\theta}
...
\begin{align*}
  ...
  &=
    ...
    + \dfrac{\partial A_\theta}{\partial r}\,\xhat{r}\cdot\xhat{\theta}
    + \dfrac{1}{r}
    \left(%
    \dfrac{\partial A_r}{\partial\theta}\xhat{\theta}\cdot\xhat{r}
    + A_r \theta
    + \dfrac{\partial A_r}{\partial\theta}\xhat{\theta}\cdot\xhat{r}
    \right)
\end{align*}
