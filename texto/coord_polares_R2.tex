...
\begin{enumerate}
\item Analizar el sistema de coordenadas polares planas y la expresión del resultado de
  distintas operaciones en este sistema.
...
rectangulares, en adelante, \emph{coordenadas cartesianas}, mientras no se diga lo contrario.

Después nos adentramos en la descripción de las coordenadas polares planas y operaciones
