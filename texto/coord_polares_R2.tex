  ...
  \begin{figure}[ht]
    ...
    \begin{minipage}{0.42\linewidth}
      ...
      \begin{tikzpicture}[%
        ...
        rtxt/.style={black},
        %rfin/.style={-{Latex[width=4pt,length=6pt]}, line width=1pt, \colorVred},
      ...
      \caption{Al cambiar la coordenada $r$, manteniendo constante $\theta$, se recorre
        ...
        $g_{11} = 1$.}
    \label{fig:R2:polares-intuicion1}      
    \end{minipage}
    \hspace{1em}
    \begin{minipage}{0.42\linewidth}
      % Escala
      ...
      \caption{Al cambiar la coordenada $\theta$, manteniendo $r$ constante, se  recorre
        ...
        $g_{22} = r^2$.}
    \label{fig:R2:polares-intuicion2}
    \end{minipage}
  \end{figure}
