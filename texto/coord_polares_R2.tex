...
Escribimos el vector de posición de cualquier punto del espacio $\symbb{R}^2$ en
...
\subsubsection{Base fundamental y vectores unitarios}
Los vectores de la base fundamental en estas coordenadas se obtienen derivando $\vvv{r}$ con respecto de las coordenadas $x$ e $y$
\begin{subequations}
...
\subsection{Base, vectores unitarios, sus productos escalares y derivadas}
El vector $\vvv{r}$ que representa cualquier punto de $\symbb{R}^2$ se puede escribir
como
\begin{equation}
  \vvv{r} = r\cos\theta\,\uvec{\i} + r\sin\theta\,\uvec{\j}
\end{equation}
\subsubsection{Base fundamental}
Los vectores de la base fundamental $\set{\vvv{e}_r, \vvv{e}_\theta}$ (no necesariamente
unitarios) se calculan derivando el vector $\vvv{r}$ con respecto de las variables $r$ y
$\theta$.
Una base para $\xhat{r}$ con respecto de $r$
\begin{equation}
  \vvv{e}_r
...
\begin{equation}
  ...
  = \dfrac{\cos\theta\,\uvec{\i}+\sin\theta\,\uvec{\j}}{\sqrt{\cos^2\theta+\sin^2\theta}}
  = \dfrac{\cos\theta\,\uvec{\i}+\sin\theta\,\uvec{\j}}{1}
  = \cos\theta\,\uvec{\i} + \sin\theta\,\uvec{\j}
\end{equation}
El vector unitario angular es la derivada de $\vvv{r}$ con respecto de
$\theta$
\begin{equation}
  \xhat{\theta}
...
\begin{enumerate}
\item Calculamos directamente la métrica
  \[
    \mmm{g}
    = g_{ij}
    = \begin{pmatrix}
