...
\subsection{Elemento de área, Jacobiano}
...
El gradiente en polares se obtiene sustituyendo en las dos expresiones anteriores y
sumándolos. A continuación presentamos el resultado
{\small
  \begin{equation}
    \vvv{\nabla}\cdot f
    =
