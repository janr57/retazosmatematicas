...
\item Enfoque basado en la variación de los vectores unitarios.
  ...
  \begin{equation}
    ...
    = 0
  \end{equation}
  \item Al desplazarnos tangencialmente en sentido antihorario, $\xhat{r}$ cambia según
  ...
  \end{equation}
\item Al desplazarnos tangencialmente en sentido antihorario, $\xhat{\theta}$ cambia
