...
\begin{equation}
  I= \int_a^b \!f(x)\, dx
\end{equation}
y, para resolverla, realizamos la siguiente sustitución $x = g(u)$. Como consecuencia,
obtenemos también la diferencial $dx=g'(u)\,du$
\begin{equation}
  I = \int_c^d \!f(g(u))\,g'(u)\,du
\end{equation}
donde $a=g(c)$ y $b=g(d)$.
...
Aunque sea adelantar conceptos, llamamos \emph{jacobiano de la transformación} a lo que
multiplica a la diferencial de la nueva variable.
